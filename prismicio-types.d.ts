...
export interface DescriptionSliceDefaultPrimary {
  /**
   * Text field in *Description → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: description.default.primary.text
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
...
export interface PhotoSliceDefaultPrimary {
  /**
   * Image field in *Photo → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: photo.default.primary.image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  image: prismic.ImageField<never>;
}
